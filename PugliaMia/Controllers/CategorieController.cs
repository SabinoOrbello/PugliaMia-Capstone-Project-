...
namespace PugliaMia.Controllers
{
    public class CategorieController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoriaID,NomeCategoria")] Categorie categorie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoriaID,NomeCategoria")] Categorie categorie)
        {
            if (ModelState.IsValid)
            {
